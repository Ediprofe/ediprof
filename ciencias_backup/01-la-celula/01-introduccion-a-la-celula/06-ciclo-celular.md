...
![la-interfase-preparando-el-escenario](https://cdn.ediprofe.com/img/ciencias/qo3x-la-interfase-preparando-el-escenario.webp)
...
![velocidad-de-division-celular](https://cdn.ediprofe.com/img/ciencias/x2v0-velocidad-de-division-celular.webp)
...
De 1 célula diploide ($2n$) salen 2 células diploides ($2n$).

$$
\text{Célula Madre } (2n) \xrightarrow{\text{Mitosis}} 2 \text{ Células Hijas } (2n) \text{ idénticas}
$$

![mitosis-creacion-de-clones](https://cdn.ediprofe.com/img/ciencias/wkee-mitosis-creacion-de-clones.webp)
...
**El resultado matemático:**
De 1 célula diploide ($2n$) salen 4 células haploides ($n$).

$$
\text{Célula Madre } (2n) \xrightarrow{\text{Meiosis}} 4 \text{ Células Hijas } (n) \text{ distintas}
$$

![meiosis-creacion-de-diversidad](https://cdn.ediprofe.com/img/ciencias/siz3-meiosis-creacion-de-diversidad.webp)

---

## 🆚 Mitosis vs Meiosis

![mitosis-vs-meiosis](https://cdn.ediprofe.com/img/ciencias/cmuq-mitosis-vs-meiosis.webp)
...
\hline
\text{1 Diploide } (2n) & \text{1 Diploide } (2n) \\
\downarrow & \downarrow \\
\mathbf{2} \text{ Diploides } (2n) & \mathbf{4} \text{ Haploides } (n) \\
\textit{(Idénticas)} & \textit{(Diferentes)}
\end{array}
$$
...
**Resultado:**
En la fase $\boxed{S \text{ (Síntesis)}}$.
...
**Resultado:**
La mitosis produce $\boxed{2}$ células, mientras la meiosis produce $\boxed{4}$.
...
**Datos:**
- Célula somática (músculo): 20 cromosomas ($2n$).
- Célula sexual (espermatozoide): requiere meiosis.

**Razonamiento:**
La meiosis reduce la carga genética a la **mitad** ($n$) para que al fecundar se restaure el número original.

$$
\text{Cromosomas sexuales} = \frac{\text{Cromosomas somáticos}}{2} = \frac{20}{2}
$$

**Resultado:**
Tendrán $\boxed{10 \text{ cromosomas}}$.
...
**Razonamiento:**
- Si hicieran mitosis, tendrían la carga completa ($2n$).
- Al unirse (fecundación): $2n + 2n = 4n$.
...
**Resultado:**
La descendencia tendría el $\boxed{\text{doble de cromosomas}}$ necesarios, causando errores genéticos graves.
...
**Resultado:**
Se requiere mitosis para mantener la $\boxed{\text{identidad y función}}$ del tejido.
...
**Resultado:**
(a) y (c) son $\boxed{\text{Mitosis}}$, (b) es $\boxed{\text{Meiosis}}$.
...
**Resultado:**
Garantiza que el ADN esté $\boxed{\text{copiado correctamente}}$ y sin daños.
...
**Resultado:**
Estás observando una $\boxed{\text{Meiosis}}$.
...
| :--- | :--- | :--- |
| **Tipo de célula** | Somática (Cuerpo) | Sexual (Gameto) |
| **Función** | Crecimiento, Reparación | Reproducción Sexual |
| **Hijas** | 2 clones idénticos | 4 células diferentes |
| **Cromosomas** | Se mantienen ($2n \to 2n$) | Se reducen a la mitad ($2n \to n$) |
...
![resumen-mitosis-vs-meiosis](https://cdn.ediprofe.com/img/ciencias/2grt-resumen-mitosis-vs-meiosis.webp)
