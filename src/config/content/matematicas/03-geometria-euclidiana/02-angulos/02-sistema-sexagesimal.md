...
2.  **Minuto ($'$):** Si tomas un grado y lo partes en 60 pedacitos, cada uno es un minuto.
    $$
    1^\circ = 60'
    $$
3.  **Segundo ($''$):** Si tomas un minuto y lo partes en 60, obtienes un segundo.
    $$
    1' = 60''
    $$
...
|:--- |:--- |:--- |
| **Grado** | $^\circ$ | $1/360$ de vuelta |
| **Minuto** | $'$ | $1/60$ de grado |
