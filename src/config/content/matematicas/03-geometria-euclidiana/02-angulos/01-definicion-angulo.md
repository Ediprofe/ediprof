---
title: "Definición de Ángulo"
---

# **Definición de Ángulo**

¿Qué tienen en común las manecillas de un reloj, la esquina de tu mesa y una pizza cortada? Todos tienen ángulos. El ángulo es la medida de cuánto "gira" una línea respecto a otra. Es lo que nos permite diferenciar una esquina afilada de una suave curva.

---

## 🎯 ¿Qué vas a aprender?

- Qué es exactamente un ángulo (no es solo una "esquina").
- Los tres elementos que lo forman: vértice, lados y abertura.
- Cómo escribir su nombre correctamente (notación).
- Por qué un ángulo positivo gira "al revés" del reloj.

---

## 📐 Anatomía de un Ángulo

Un ángulo está formado por dos **rayos** que salen del mismo punto.

### Elementos Clave
1.  **Vértice ($V$):** El punto de donde nacen los dos rayos. El origen común.
2.  **Lados:** Los dos rayos que forman el ángulo.
3.  **Abertura:** El espacio "barrido" entre un lado y otro.

### Notación (El nombre del ángulo)
Si tenemos un ángulo con vértice en $B$, y puntos $A$ y $C$ en los lados:

- **Tres letras:** $\angle ABC$ o $\angle CBA$. (La letra del vértice $B$ **siempre** va en el medio).
...
### Ejercicio 1
Dibuja (mentalmente) un ángulo formado por los rayos $\overrightarrow{OA}$ y $\overrightarrow{OB}$. ¿Quién es el vértice?
...
### Ejercicio 2
Escribe la notación para un ángulo con vértice $M$ y puntos $L, N$ en los lados.

<details>
<summary>Ver solución</summary>

$\angle LMN$ o $\angle NML$.
...
### Ejercicio 3
¿Es $\angle ABC$ lo mismo que $\angle BAC$?

<details>
<summary>Ver solución</summary>

No. El vértice cambia de $B$ a $A$. Son ángulos diferentes.
...
### Ejercicio 4
Si las manecillas del reloj van de las 12 a las 3, ¿el ángulo geométrico es positivo o negativo?
...
### Ejercicio 5
¿Qué letra griega se usa comúnmente para ángulos desconocidos?

<details>
<summary>Ver solución</summary>

$\theta$ (theta) o $\alpha$ (alfa).
...
### Ejercicio 6
Un ángulo completo (vuelta entera) mide...
...
### Ejercicio 7
En la notación $\angle P$, ¿qué representa $P$?
...
### Ejercicio 8
Verdadero o Falso: Los lados de un ángulo son segmentos finitos.

<details>
<summary>Ver solución</summary>

Falso. Son rayos (infinitos), aunque los dibujemos cortos.
...
### Ejercicio 9
¿Cómo se llama el lado donde "empieza" la medición del ángulo?
...
| Concepto | Definición |
|:--- |:--- |
| **Vértice** | El punto de esquina. |
| **Lados** | Los dos rayos que lo forman. |
| **Positivo** | Giro Antihorario (↺). |
| **Negativo** | Giro Horario (↻). |

> **Conclusión:** Un ángulo no es una cosa estática, es una acción: un giro. Nos dice cuánto tenemos que rotar para apuntar en una nueva dirección.
