...
| Operación | Significado | Fórmula |
|:--- |:--- |:--- |
| **Escalar Positivo** | Magnifica el complejo | $k(a+bi) = ka + kbi$ |
| **Escalar Negativo** | Magnifica e invierte dirección | $-k(a+bi) = -ka - kbi$ |
| **Neutro** | No cambia nada | $1 \cdot z = z$ |
