---
title: "Ecuaciones con Fracciones"
---
...
$$
8 \cdot \frac{3x}{4} - 8 \cdot \frac{x}{2} = 8 \cdot \frac{1}{8}
$$
...
|:--- |:--- |
| **MCM** | Buscar el número más pequeño divisible por todos los denominadores. |
| **Transformación** | Al multiplicar por el MCM, la ecuación deja de tener fracciones. |
| **Precaución** | Si hay un signo menos antes de una fracción, afecta a **todo** el numerador. |
