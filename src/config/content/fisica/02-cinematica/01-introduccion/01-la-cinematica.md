...
La **Mecánica** es la rama fundamental de la física que estudia el movimiento y el equilibrio de los cuerpos. Podemos imaginarla como el área general que abarca todo el estudio del movimiento, y que se divide en dos ramas principales para su análisis:

1.  **Cinemática:** Es la rama descriptiva. Se ocupa del **¿CÓMO?** se mueven los cuerpos (su posición, velocidad, trayectoria) sin preocuparse por las causas.
2.  **Dinámica:** Es la rama explicativa. Se ocupa del **¿POR QUÉ?** se mueven los cuerpos (analizando las fuerzas y la masa que originan el movimiento).

En esta lección y las siguientes, nos adentraremos en la primera de estas ramas: la **Cinemática**.

---

## 🎯 ¿Qué vas a aprender?

- La diferencia fundamental entre cinemática y dinámica.
- Las variables principales que describen el movimiento.
- Qué es el modelo de partícula y cuándo es válido utilizarlo.
...
### Ejercicio 1
**Un ingeniero calcula la fuerza necesaria para que un cohete despegue. ¿Está haciendo cinemática o dinámica?**

<details>
<summary>Ver solución</summary>

**Dinámica.** Al involucrar fuerzas y causas del movimiento, pertenece al estudio de la dinámica.
...
### Ejercicio 2
**Un GPS calcula cuánto tiempo tardarás en llegar a tu destino basándose en tu velocidad actual. ¿Está haciendo cinemática o dinámica?**

<details>
<summary>Ver solución</summary>

**Cinemática.** Se enfoca en la descripción del movimiento (posición, tiempo, velocidad) sin analizar las fuerzas que lo producen.
