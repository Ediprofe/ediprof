...
Cuando una sustancia gana o pierde energía, puede pasar de un estado de agregación a otro. Estos procesos se llaman cambios de estado.

---

## 🎯 ¿Qué vas a aprender?

- Los seis cambios de estado de la materia
- Qué ocurre con las partículas en cada cambio
- La diferencia entre procesos endotérmicos y exotérmicos

---

## 📖 ¿Qué es un cambio de estado?

> Un **cambio de estado** es la transformación de una sustancia de un estado de agregación a otro, causada por un cambio de temperatura o presión.
...
> **Fusión** = paso de **sólido → líquido**

### 💡 Ejemplo:
El hielo se derrite a 0 °C y se convierte en agua líquida.
...
> **Solidificación** = paso de **líquido → sólido**

### 💡 Ejemplo:
El agua se congela a 0 °C y se convierte en hielo.
...
> **Condensación** = paso de **gas → líquido**

### 💡 Ejemplo:
El vapor de agua en el aire se condensa en las ventanas frías.
...
> **Sublimación** = paso de **sólido → gas** (sin pasar por líquido)
...
> **Deposición** (o sublimación inversa) = paso de **gas → sólido**
...
|--------|-------|-------|---------|
| Fusión | Sólido | Líquido | Se absorbe |
| Solidificación | Líquido | Sólido | Se libera |
| Vaporización | Líquido | Gas | Se absorbe |
| Condensación | Gas | Líquido | Se libera |
| Sublimación | Sólido | Gas | Se absorbe |
| Deposición | Gas | Sólido | Se libera |

> Los cambios que **absorben energía** (fusión, vaporización, sublimación) son **endotérmicos**.
> Los cambios que **liberan energía** (solidificación, condensación, deposición) son **exotérmicos**.
...
### Ejercicio 1
¿Qué cambio de estado ocurre cuando dejas un vaso de agua afuera en un día muy frío?

<details>
<summary>Ver solución</summary>

Ocurre la **solidificación**: el agua líquida pierde calor y se convierte en hielo (sólido).

</details>

### Ejercicio 2
¿Por qué después de una ducha caliente el espejo del baño se empaña?

<details>
<summary>Ver solución</summary>

Porque el vapor de agua caliente del ambiente se **condensa** al entrar en contacto con la superficie fría del espejo, formando gotitas de agua líquida.

</details>

### Ejercicio 3
El hielo seco (CO₂ sólido) desaparece sin dejar charco. ¿Qué cambio de estado ocurre?

<details>
<summary>Ver solución</summary>

Ocurre la **sublimación**: el CO₂ sólido pasa directamente a gas sin pasar por el estado líquido.

</details>

### Ejercicio 4
¿Por qué la ropa mojada se seca al sol aunque no está hirviendo?

<details>
<summary>Ver solución</summary>

Por **evaporación**. Es un tipo de vaporización que ocurre lentamente en la superficie del líquido, sin necesidad de alcanzar la temperatura de ebullición.

</details>

### Ejercicio 5
Clasifica los siguientes cambios como endotérmicos o exotérmicos:
a) Hervir agua
b) Formar escarcha
...
a) **Endotérmico** (vaporización: absorbe calor)
b) **Exotérmico** (deposición: libera calor)
c) **Endotérmico** (fusión: absorbe calor)
