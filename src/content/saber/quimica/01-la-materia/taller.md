...
Practica con preguntas tipo Saber 11 sobre propiedades, clasificación y cambios de la materia.
...
- Clasificar sustancias puras y mezclas.
- Analizar métodos de separación de mezclas.
- Interpretar gráficas y tablas de datos experimentales.
...
![Candado de hierro](https://cdn.ediprofe.com/img/saber/quimica/candado-de-hierro.webp)
...
![sustancias-y-densidades](https://cdn.ediprofe.com/img/saber/quimica/sustancias-y-densidades.webp)
...
- A **1.535 °C** ocurre el cambio de sólido a líquido → **Debe haber una meseta horizontal**.
- A **2.750 °C** ocurre el cambio de líquido a gaseoso → **Debe haber otra meseta horizontal**.

La **Gráfica C** es la única que muestra estos dos periodos de temperatura constante (líneas horizontales) correspondientes a los cambios de fase.
...
1. **Punto de ebullición < 130 °C:** Todas las sustancias en la tabla cumplen este requisito.
2. **Soluble en agua:** Las sustancias 1, 2 y 4 son solubles. Se descarta la sustancia 3.
3. **No conductora de electricidad:** De las restantes (1, 2 y 4), la única que **no** es conductora es la **sustancia 4**.
...
Un estudiante escribe como hipótesis que estos dos líquidos se mezclan **formando una solución homogénea**; luego... observa que **se forman dos capas**...
...
Un grupo de científicos realizó una consulta para determinar cuál ha sido el comportamiento de las emisiones anuales de $CH_4$ entre el 2000 y el 2020. Los resultados encontrados se muestran en la siguiente gráfica:

![Toneladas de metano al año](https://cdn.ediprofe.com/img/saber/quimica/toneladas-metano-al-año.webp)
...
![Biodigestor](https://cdn.ediprofe.com/img/saber/quimica/biodigestor.webp)
...
- La **balanza** (A) se utiliza para medir la masa.
- El **densímetro** (B) mide la densidad relativa de los líquidos.
- La **probeta** (D) es un instrumento volumétrico que permite medir volúmenes.
...
![Solución amarilla](https://cdn.ediprofe.com/img/saber/quimica/solucion-amarilla.webp)
...
Al disolver el yoduro de potasio (KI) en agua y obtener una solución que es **totalmente uniforme** y **sin fases visibles**, estamos ante una **mezcla homogénea**. Según la tabla proporcionada, las mezclas homogéneas son aquellas donde los componentes se distribuyen uniformemente sin formar fases distintas.
...
Un estudiante desea determinar cuánto tiempo tarda una olla con agua, sometida al fuego de una estufa, en calentarse hasta los 80 °C. Para esto, él prepara el experimento sacando de la nevera 100 mL de agua a 4 °C y procede a verterla en la olla y calentarla a fuego lento.

![Olla caliente](https://cdn.ediprofe.com/img/saber/quimica/olla-caliente.webp)
...
La afirmación del estudiante es una **conclusión** porque no se limita a repetir un único dato observado (evidencia), sino que sintetiza la relación o tendencia general encontrada entre las dos variables estudiadas: el calor específico y la variación de temperatura. En la tabla se observa que a medida que aumentan los valores de calor específico, los valores de temperatura final disminuyen hacia la temperatura inicial, lo que confirma que la sustancia opone mayor resistencia a cambiar su temperatura.
...
![Métodos de separación de mezclas](https://cdn.ediprofe.com/img/saber/quimica/metodos-de-separacion-1.webp)
...
![Destilación y decantación](https://cdn.ediprofe.com/img/saber/quimica/destilacion-y-decantacion.webp)
...
![Filtración de agua con sal y agua con carbonato de calcio](https://cdn.ediprofe.com/img/saber/quimica/filtracion-agua-sal-y-agua-carbonato.webp)
...
![Comienzo y final de la destilación](https://cdn.ediprofe.com/img/saber/quimica/comienzo-final-destilacion.webp)
...
![Mezcla filtrada](https://cdn.ediprofe.com/img/saber/quimica/mezcla-filtrado-solido-gas.webp)
...
![Cromatografía de muestras 1 y 2](https://cdn.ediprofe.com/img/saber/quimica/cromatografia-de-muestras-1-y-2.webp)
...
![Cromatografía de 3 sustancias](https://cdn.ediprofe.com/img/saber/quimica/cromatografia-de-3-sustancias.webp)
...
|----------|-------------|
| **Sustancia pura** | Elemento (un tipo de átomo) o compuesto (unión química de elementos) |
| **Mezcla homogénea** | Componentes uniformemente distribuidos, una sola fase |
| **Mezcla heterogénea** | Componentes distinguibles a simple vista, varias fases |
| **Propiedades intensivas** | No dependen de la cantidad (densidad, temperatura de ebullición) |
| **Propiedades extensivas** | Dependen de la cantidad (masa, volumen) |
| **Filtración** | Separa sólido insoluble de líquido |
| **Evaporación** | Separa sólido disuelto de líquido |
| **Destilación** | Separa líquidos con diferentes puntos de ebullición |
| **Decantación** | Separa líquidos inmiscibles por densidad |
| **Cromatografía** | Separa componentes por afinidad con el medio |

> El dominio de la clasificación de la materia y los métodos de separación es fundamental para el análisis científico de cualquier sustancia.
