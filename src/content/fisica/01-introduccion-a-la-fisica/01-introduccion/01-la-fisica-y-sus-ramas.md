...
- Las ramas de la física clásica
...
![Mapa conceptual de las ramas de la física](/images/mindmap/fisica-ramas.svg)
...
### Ejercicio 1
**¿Qué rama de la física estudia el movimiento de los planetas alrededor del Sol?**

<details>
<summary>Ver solución</summary>

**Mecánica clásica** (específicamente la mecánica celeste). Los planetas se mueven a velocidades muy menores que la luz y son objetos macroscópicos, por lo que las leyes de Newton son suficientes para describir su movimiento.
...
### Ejercicio 2
**Un científico estudia cómo la luz se curva al pasar cerca de un agujero negro. ¿A qué rama pertenece este fenómeno?**

<details>
<summary>Ver solución</summary>

**Relatividad** (física moderna). La curvatura de la luz por grandes masas es un efecto predicho por la teoría de la relatividad general de Einstein.
...
### Ejercicio 3
**Clasifica los siguientes fenómenos en física clásica (C) o física moderna (M):**

a) El arcoíris  
b) La radiactividad del uranio  
c) El eco en una montaña  
d) El láser  
...
b) **M** - Física nuclear  
c) **C** - Acústica  
d) **M** - Mecánica cuántica (emisión estimulada)
...
|----------|-------------|
| **Física** | Ciencia que estudia materia, energía e interacciones |
| **Física clásica** | Fenómenos a escala humana (mecánica, óptica, etc.) |
| **Física moderna** | Fenómenos extremos (cuántica, relatividad, etc.) |
| **Aplicación** | Base de la tecnología e ingeniería moderna |
