...
**"Sumar 1 al exponente y dividir entre el nuevo exponente."**
...
¡La regla de potencia no aplica aquí! ($\frac{x^0}{0}$ no existe)
...
$$\int \left(\frac{3}{x^2} + 2\sqrt{x}\right)\,dx = \int (3x^{-2} + 2x^{1/2})\,dx$$
...
b) $\int 5x^{-3}\,dx = -\frac{5}{2}x^{-2} + C = -\frac{5}{2x^2} + C$

c) $\int x^{3/4}\,dx = \frac{x^{7/4}}{7/4} + C = \frac{4}{7}x^{7/4} + C$
</details>
...
Expandimos: $(x + \frac{1}{x})^2 = x^2 + 2 + \frac{1}{x^2}$
