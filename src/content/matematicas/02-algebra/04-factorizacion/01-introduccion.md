...
Existen varios métodos de factorización que estudiaremos en las siguientes lecciones:
...
| 5 | Trinomio $x^2 + bx + c$ | $(x + m)(x + n)$ donde $m + n = b$, $mn = c$ |
| 6 | Trinomio $ax^2 + bx + c$ | Varios métodos |
