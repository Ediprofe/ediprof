...
document.addEventListener('DOMContentLoaded', function() {
  if (typeof echarts !== 'undefined' && document.getElementById('echarts-plano-intro')) {
    ...
    var option = {
      title: { text: 'El Plano Cartesiano', subtext: 'Sistema de coordenadas con cuatro cuadrantes', left: 'center', textStyle: { fontSize: 16, fontWeight: 'bold', color: '#1e293b' }, subtextStyle: { fontSize: 12, color: '#64748b' } },
      animation: true, animationDuration: 1000,
      grid: { left: '10%', right: '10%', top: '15%', bottom: '12%', show: true, borderColor: '#cbd5e1' },
      xAxis: { type: 'value', name: 'Eje X', nameLocation: 'end', nameTextStyle: { fontSize: 13, fontWeight: 'bold', color: '#374151' }, min: -6, max: 6, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      yAxis: { type: 'value', name: 'Eje Y', nameLocation: 'end', nameTextStyle: { fontSize: 13, fontWeight: 'bold', color: '#374151' }, min: -6, max: 6, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      series: [
        { type: 'scatter', symbolSize: 18, itemStyle: { color: '#ef4444', borderColor: '#fff', borderWidth: 2 }, label: { show: true, formatter: 'Origen (0,0)', position: 'bottom', fontSize: 11, fontWeight: 'bold', color: '#ef4444' }, data: [[0, 0]] },
...
document.addEventListener('DOMContentLoaded', function() {
  if (typeof echarts !== 'undefined' && document.getElementById('echarts-puntos-ejemplos')) {
    ...
    var option = {
      title: { text: 'Puntos en el plano cartesiano', subtext: 'Cada punto en su cuadrante correspondiente', left: 'center', textStyle: { fontSize: 16, fontWeight: 'bold', color: '#1e293b' }, subtextStyle: { fontSize: 12, color: '#64748b' } },
      animation: true, animationDuration: 1000,
      grid: { left: '12%', right: '10%', top: '15%', bottom: '12%', show: true, borderColor: '#cbd5e1' },
      xAxis: { type: 'value', name: 'x', nameLocation: 'end', nameTextStyle: { fontSize: 13, fontWeight: 'bold', color: '#374151' }, min: -5, max: 6, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      yAxis: { type: 'value', name: 'y', nameLocation: 'end', nameTextStyle: { fontSize: 13, fontWeight: 'bold', color: '#374151' }, min: -5, max: 7, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      series: [
...
document.addEventListener('DOMContentLoaded', function() {
  if (typeof echarts !== 'undefined' && document.getElementById('echarts-cuadrantes')) {
    ...
    var option = {
      title: { text: 'Identificación de cuadrantes', subtext: 'Cada punto se ubica según sus signos (x, y)', left: 'center', textStyle: { fontSize: 16, fontWeight: 'bold', color: '#1e293b' }, subtextStyle: { fontSize: 12, color: '#64748b' } },
      animation: true, animationDuration: 1000,
      grid: { left: '12%', right: '10%', top: '15%', bottom: '12%', show: true, borderColor: '#cbd5e1' },
      xAxis: { type: 'value', min: -7, max: 7, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      yAxis: { type: 'value', min: -7, max: 7, axisLine: { lineStyle: { color: '#374151', width: 2 } }, splitLine: { show: true, lineStyle: { color: '#94a3b8', width: 1 } } },
      series: [
